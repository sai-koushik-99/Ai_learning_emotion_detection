...
_FILE_MAP = {
    "GDRIVE_BILSTM_NPZ":   (BILSTM_DIR / "bilstm_weights.npz",  "1O0xVTuOlMeluoYb2IkUxz2mcjPJAO_85"),
    "GDRIVE_BILSTM_TOK":   (BILSTM_DIR / "tokenizer.json",       "1LJSDzf1wd8HYGpnheR5cMmssb0V1ZaE4"),
